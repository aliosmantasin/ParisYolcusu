...
import ORLYairport from '../_components/ParisHavalimanıTransfer/ORLYairport'
import BVAairport from '../_components/ParisHavalimanıTransfer/BVAairport'
...
export async function generateMetadata() {
  const pagePath = "paris-airport-transfer"; // Sayfanın adı belirleniyor
