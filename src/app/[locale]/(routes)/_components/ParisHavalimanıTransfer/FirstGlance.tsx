  ...
  return (
    <section className="w-full bg-[#ffffff] dark:bg-black relative">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }}>
        <div className="container hidden sm:flex flex-wrap justify-center items-center min-h-[250px] border-2 mx-auto my-10 relative h-[200px] bg-[url(/images/airportTerminal.webp)] bg-cover bg-cente rounded-xl shadow-xl brightness-100 dark:brightness-50 ">
      ...
      {/* Mobil Görünüm */}
      <div className="container flex sm:hidden flex-wrap justify-center items-center min-h-[60vh] border-2 mx-auto my-10 relative h-[auto] bg-[url(/images/airportTerminal.webp)] bg-cover bg-center">
