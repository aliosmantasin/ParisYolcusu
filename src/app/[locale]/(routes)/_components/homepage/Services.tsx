...
const Services = () => {
    ...
    const features = [
  {
    ...
    moreInfoUrl: t("moreInfoLink"),
    applyButtonText: t("applyButton"),
    applyButtonLink: t("apllyLink"),
  },
  {
    ...
    <section className='py-10 my-10 bg-slate-50 dark:bg-black relative' id='hizmetlerimiz'>
        <div className='container flex flex-wrap justify-between gap-10  mx-auto'>
            ...
            <div className='w-full flex justify-center items-center my-5 text-center'>
                <div>
                  <h2 className='font-bold text-2xl primary'>{t("title")}</h2>
                  <p>{t("description")}</p>
                </div>
            </div>
            ...
            {features.map((feature, index) => (
             ...
             <div className="flex flex-col items-center pb-10">
                 <Image className='w-32 h-32 mb-3 rounded-xl shadow-lg p-2 border border-[#fece47] object-contain' src={feature.img1 ?? "/images/default-image.jpg"} alt='gorsel1' width={200} height={200} />
